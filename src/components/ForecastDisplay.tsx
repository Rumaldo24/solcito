  ...
  return (
    <div className={`${cardClasses} max-w-6xl mx-auto`}>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className={`text-2xl font-bold ${textClasses}`}>
          {translation.forecast5Day}
        </h3>
      </div>
          ...
          return (
            ...
            >
              <div className="text-center">
                ...
                <div
                  className={`text-xs ${secondaryTextClasses} mb-3 leading-tight`}
                >
      ...
      <div className="mt-8">
        <h4 className={`text-lg font-semibold ${textClasses} mb-4`}>
          {translation.todayHourlyForecast}
        </h4>
            ...
            return (
              <div
                ...
                className={`flex-shrink-0 p-3 rounded-xl text-center min-w-[80px]
                  ${isDark ? "bg-slate-700/30" : "bg-white/10"} border ${
                  isDark ? "border-slate-600/30" : "border-white/20"
                }`}
              >
                <div className={`text-xs ${secondaryTextClasses} mb-2`}>
                  {time}
                </div>
                <img
                  src={getWeatherIcon(item.weather[0].icon)}
